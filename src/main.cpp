...
uint256 hashGenesisBlock("0xd8d041b3861a6019e0f3ce22c4484773ab5047e472465d4c62950b663ff0c41d");
...
static const int64 nTargetTimespan = 10 * 30; // Learncoin: 3m
static const int64 nTargetSpacing = 1 * 30; // Learncoin: 30s
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd8d041b3861a6019e0f3ce22c4484773ab5047e472465d4c62950b663ff0c41d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        //     CTxOut(nValue=50.00000000, Key=040184710fa689ad5023690c80f3a4)
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("1234ss84710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1511960467;
        ...
        assert(block.hashMerkleRoot == uint256("0x88626131618af4d8b25984fe0c8f9340481ba3bcc4a4332a016eb3145365dfc1"));
